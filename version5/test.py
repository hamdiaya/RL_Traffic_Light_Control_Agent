...
MAX_STEPS = 7200
FIXED_SEED = 42
MAX_WAITING = 600  # From TrafficEnv.get_state for denormalization
...
def run_episode(use_agent=True, seed=None):
    ...
    while not done and step < MAX_STEPS:
        ...
        wait_total_list.append(np.mean(wait_times))  # Average over 4 edges
        queue_total_list.append(np.mean(queue_lengths))  # Average over 4 edges
