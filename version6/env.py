...
class TrafficEnv:
    def __init__(self):
        ...
        # State & action spaces
        self.state_size  = 16
        # Define discrete duration options (short, medium, long)
    ...
    def calculate_reward(self):
        ...
        # Norms
        MAX_WAIT=3600; MAX_Q=200; MAX_T=60
        reward = (1.5*(delta_wait/MAX_WAIT) + 1.0*(delta_q/MAX_Q) + 0.8*(throughput/MAX_T))
